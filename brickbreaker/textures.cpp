...
{
    SDL_Surface* tempsurf = IMG_Load("assets/bckgrd.jpg");
    bckgrd = SDL_CreateTextureFromSurface(gamerenderer, tempsurf);
    tempsurf = IMG_Load("assets/brick1.png");
    brick1 = SDL_CreateTextureFromSurface(gamerenderer, tempsurf);
    tempsurf = IMG_Load("assets/brick2.png");
    brick2 = SDL_CreateTextureFromSurface(gamerenderer, tempsurf);
    tempsurf = IMG_Load("assets/brick3.png");
    brick3 = SDL_CreateTextureFromSurface(gamerenderer, tempsurf);
    tempsurf = IMG_Load("assets/brick4.png");
...
{
    SDL_RenderCopy(gamerenderer, bckgrd, NULL, NULL);
}
